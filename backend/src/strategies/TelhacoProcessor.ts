...
import { exportToTxt289, processarArquivo289Telhacao } from "src/Regras/TELHAÇO/289/ProcessarArquivo289";
...
export class TelhacoProcessor implements IEmpresaProcessor {
    ...
    async processUnificado(
        ...
        try {
            ...
            await processarArquivos257_1Telhaco(inputExcelPath, output257_1);
        ...
        try {
            ...
            await processarArquivos257_2Telhaco(inputExcelPath, output257_2);
        ...
        try {
            ...
            result['regra282'] = error ? `Erro o enviar: ${error.message}` : supabasePath;
        } catch (err: any) {
        ...
        try {
            ...
            result['regra284'] = error ? `Erro ao enviae: ${error.message}` : supabasePath;
        } catch (err: any) {
    ...
    async processRegra289(
        ...
        try {
          ...
          const { contabil, fiscal, duplicatas } = await processarArquivo289Telhacao(pagamentosPath, duplicatasPath);
