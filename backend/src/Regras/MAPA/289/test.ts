...
async function testarProcessamento() {
  try {
    console.log('Iniciando o teste da regra MAPA 289...');
    ...
    console.log('Teste da regra MAPA 289 concluído com sucesso!');
    ...
    console.error('Erro durante o teste da regra MAPA 289:', error);
  }
}
