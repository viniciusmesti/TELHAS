...
//Função principal que orquestra a leitura, transformação e exportação dos dados da Regra 255 para a empresa TELHAÇO.	
...
export async function processarArquivo255(inputExcelPath: string, outputTxtPath: string): Promise<void> {
    try {
        ...
        console.log('Transformando os dados (Regra 255) para TELHAÇO...');
