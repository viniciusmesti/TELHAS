  ...
  rows.forEach((row, index) => {
    ...
    if (filial === "13") {
      ...
      if (historicoReferencia !== "DEPOSITO") {
        console.log(`Linha ${index + 1} ignorada - Transferência em filial somente para DEPOSITO. Histórico: ${historicoReferencia}`);
        return;
      }
      ...
      output.push(`0001;${dataBaixa};${contaDebitoExtra};${contaCreditoExtra};${valorBaixa};${hist}`);
    }
  });
