...
export function processarRegra347(rows: any[]): string[] {
  ...
  const localMapGrupo1: Record<string, string> = {
    "5": "0001", "7": "0003", "10": "0004", "11": "0005", "12": "0006"
  };
  const localMapGrupo2: Record<string, string> = {
    "505": "0001", "507": "0003", "510": "0004", "511": "0005", "512": "0006"
  };

  const contaExtraGrupo1: Record<string, string> = {
    "7": "1000", "10": "2053", "11": "2054", "12": "2256"
  };
  const contaExtraGrupo2: Record<string, string> = {
    "507": "1000", "510": "2053", "511": "2054", "512": "2256"
  };
  ...
  rows.forEach((row, index) => {
    ...
    const local = grupo === 1 ? localMapGrupo1[codLocal] : localMapGrupo2[codLocal];
    ...
    if (grupo === 1) {
      if (codLocal === "5") {
        ...
        output.push(`0001;${dataBaixa};${banco};${contaExtra};${valor};${historicoBase}`);
      }
    } else if (grupo === 2) {
      if (codLocal === "505") {
