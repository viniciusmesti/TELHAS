...
export class SupabaseService {
  ...
  async uploadFile(file: Express.Multer.File, codigoSistema: string): Promise<string> {
  ...
  async uploadProcessedFile(filePath: string, fileBuffer: Buffer, codigoSistema: string) {
    try {
